		...
		userLeaderboards.count({ userId: userId }, function(err, userCount) {
			...
			if (userCount < 1) {
				var userStats = {
					...
					dailyAchievementRank: {value: 0, rank: 0},
					weeklyRank: {value: 0, rank: 0},
					weeklyAchievementRank: {value: 0, rank: 0},
					monthlyRank: {value: 0, rank: 0},
					monthlyAchievementRank: {value: 0, rank: 0},
