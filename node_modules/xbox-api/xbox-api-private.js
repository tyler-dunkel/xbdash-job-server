...
// 	xboxApiCaller(url, function(err, res) {
// 		if (res) {
// 			if (!res || !res.data) return;
// 			if (_.isEmpty(res.data)) return;
// 			if (typeof res.data.each !== 'function') return;

// 			Client.connect(meteorUrl, function (err, res) {
// 				if (err) throw err;

// 				var xbdAchievements = res.collection('xbdachievements');
// 				var userAchievements = res.collection('userachievements');

// 				res.data.each(achievement, function(err) {
// 					if (err) return;

// 					xbdAchievements.findOne({ gameId: gameId, name: achievement.name }, {}, function(err, achievement){
...
// 								userPercentage: 0
// 							};
// 							achievement = xbdAchievements.insert(singleAchievement);
...
// 							userAchievements.upsert({ achievementId: achievement, userId: userId }, { $set: userAchievement });
// 						}
// 					});
// 				});
// 				callback(null, res);
